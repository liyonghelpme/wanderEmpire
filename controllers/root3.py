...
class RootController(BaseController):
    ...
    Building_Price=[[1000,0,100,0,0],[500,10,0,1,600],[1000,30,0,1,1200],[1500,60,0,1,1800],[1000,60,0,1,1800],[1500,100,0,1,2400],[2000,200,0,1,3000],[2000,200,0,2,3600],[2500,300,0,2,4200],[3000,400,0,2,4800],[3000,400,0,2,5400],[3500,500,0,2,6000],[4000,600,0,2,6600],[4000,600,0,3,7200],[5000,700,0,3,7800],[6000,800,0,3,8400],[-5,0,0,3,10800],[-10,0,0,3,11400],[-20,0,0,3,12000],[5000,150,150,1,3600],[15000,300,20,2,7200],[50000,600,50,3,14400],[100,20,20,1,600],[300,30,5,1,1800],[500,50,10,1,3600],[600,30,20,1,1800],[750,50,5,1,3600],[900,70,5,1,5400],[1200,50,40,2,3600],[1400,70,5,2,5400],[1600,100,5,2,7200],[1800,100,70,2,5400],[2100,130,5,2,7200],[2400,150,5,2,9000],[2400,130,90,3,7200],[2800,150,5,3,9000],[3200,170,5,3,10800],[7200,150,110,3,10800],[10200,170,5,3,12600],[13200,200,5,3,14400],[-1,0,0,4,14400],[-3,0,0,4,16200],[-5,0,0,4,18000],[-2,0,0,4,18000],[-5,0,0,4,19800],[-10,0,5,4,21600]]#corn,food,labor_num,cae 0:nongtian 1-18:minju 19-21:bingying 22-shangye
    Plant_Price=[[50,0,1,600],[140,0,1,1800],[255,0,1,3600],[-1,0,1,3600],[504,0,1,7200],[575,0,2,9000],[660,0,2,10800],[-2,0,2,10800],[1265,0,2,14400],[1386,0,3,18000],[1470,0,3,21600],[-5,0,3,21600]]#corn,food,cae
    ...
    soldie=[[1200,60,20,3,2700],[3100,155,50,3,7200],[6200,310,100,3,18000],[2400,120,20,3,2700],[6200,310,50,3,7200],[12400,620,100,3,18000],[3600,180,20,3,2700],[9300,465,50,3,7200],[18600,930,100,3,18000],[6000,300,20,6,7200],[15100,755,50,6,19800],[30200,1600,100,6,39600],[7500,375,20,6,7200],[18875,943,50,6,19800],[37750,2000,100,6,39600],[9000,450,20,6,7200],[22650,1132,50,6,19800],[45300,2400,100,6,39600],[800,10,2,9,10800],[2100,30,5,9,21600],[4200,60,10,9,43200],[1000,20,2,9,10800],[2700,60,5,9,21600],[5400,120,10,9,43200],[1200,40,2,9,10800],[3300,120,5,9,21600],[6600,240,10,9,43200]]#corn,food,labor_num,cae
        ...
        try:
            ...
            if p.ground_id==0:
                ...
                if u.cae-caesars>=0:
                    ...
                    return dict(id=0)
            elif  p.ground_id>=1 and p.ground_id<=18:
                if p.finish==0:
                    caesars=(Building_Price[p.ground_id][4]-t+3600-1)/3600
                    if u.cae-caesars>=0:
                        u.cae=u.cae-caesars
                        tu=increasebuild[p.ground_id]
                        p.producttime=0
                    ...
                    caesars=(houses[p.ground_id-1][3]-t+3600-1)/3600
                    if u.cae-caesars>=0:
                        u.cae=u.cae-caesars
                ...
                if p.finish==0:
                    ...
                    caesars=(production[p.ground_id-22][3]-t+3600-1)/3600
                    if u.cae-caesars>=0:   
